function trajectory_cost = cost_function(x, C_u, C_v, C_w, ...
    ...
    A_ob = 1;
    % OBS: alpha_ob tem pouca influência no resultado entre 3 e 0.125,
    % 0.12 é OK, qualquer valor menor do que isso causa superposição
    % da aeronave e do obstáculo
    alpha_ob = 1;
    ...
    performance_margin = vehicle_constraints_cost(gamma_a);
