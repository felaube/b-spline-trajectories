function [x, y, z, u, v, w, ...
    ...
    %% Calculate thrust
    %C_L = 2*n*mass*g./(rho*S*V(3:end).^2);
    ...
    %T = D + mass*V_dot(2:end) + mass*g*sin(gamma(3:end));
    ...
    hold on
    plot3(prev_x, prev_y, prev_z,'-o','Color','r','MarkerSize',10, 'MarkerFaceColor', prev_color)
