function trajectory_cost = cost_function(x, C_u, C_v, C_w, ...
    ...
    for i = 1 : m
        distance = obstacle_distance(x_obs(i), y_obs(i), z_obs(i), R_obs(i), x_a, y_a, z_a, safe_distance);
    ...
    % Saturation of costs to avoid NaN and Inf results for the objective
    % function
